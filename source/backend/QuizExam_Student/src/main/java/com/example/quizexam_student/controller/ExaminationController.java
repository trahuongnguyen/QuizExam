...
public class ExaminationController {
    ...
    public ExaminationResponse autoGenerateExam(@RequestBody @Valid ExaminationRequest examinationRequest) {
        return ExaminationMapper.convertToResponse(examinationService.createAutoGeneratedExam(examinationRequest));
    }
    ...
    public ExaminationResponse selectQuestionsExam(@RequestPart(name = "exam") @Valid ExaminationRequest examinationRequest, @RequestPart(name = "question") List<Integer> questionIds) {
        return ExaminationMapper.convertToResponse(examinationService.createExamFromSelectedQuestions(examinationRequest, questionIds));
    }
    ...
    public ExaminationResponse updateQuestionForExam(@PathVariable int examinationId, @RequestBody List<Integer> questionIds) {
        return ExaminationMapper.convertToResponse(examinationService.updateExamQuestion(examinationId, questionIds));
    }
