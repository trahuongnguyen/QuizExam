...
public interface ExaminationService {
    Examination createAutoGeneratedExam(ExaminationRequest examinationRequest);
    ...
    Examination createExamFromSelectedQuestions(ExaminationRequest examinationRequest, List<Integer> questionIds);

    Examination updateExamQuestion(int examinationId, List<Integer> questionIds);
